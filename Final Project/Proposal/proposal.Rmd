...
# loading data
AQI_data = read.csv(file = 'G:\\Downloads\\proj\\data\\aqi_by_State_2003-2020.csv')
birth_data = read.csv(file = "G:\\Downloads\\proj\\data\\Infant_Birth_2007-2020.csv")
death_data = read.csv(file ="G:\\Downloads\\proj\\data\\Infant_Death_2007-2019.csv")
